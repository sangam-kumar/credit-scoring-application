...
try:
    ...
    with col2:
        ...
        st.markdown('<center>**[PROJECT TARS]**</center>(https://github.com/sangam-kumar)')
        st.markdown('<center>**[Under Esteemed Guidance of Prof. Dr. Ravichandran Sivaramakrishnan]**</center>(https://github.com/sangam-kumar)')
